...
###
# This file is for collecting images that can be used to create a "class" or to add context to your LoRA
###
...
def image_page_finder():
	...
	for j in range(0, max_num_pages):
		i = randint(0, max_images)
		raw_text = call_web(i)
